        ...
        <div className="container-shell grid gap-8 lg:grid-cols-2">
          <div className="rounded-2xl bg-white p-8 shadow-lg">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-4">
              <div>
                <input {...register("name", { required: "Name is required" })} placeholder="Name" className={inputClass(!!errors.name)} />
              ...
              <div>
                <input {...register("phone", { required: "Phone is required" })} placeholder="Phone" className={inputClass(!!errors.phone)} />
              ...
              <motion.button whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} className="w-full rounded-full bg-accent px-8 py-4 font-bold text-dark" type="submit">
                Send Message
              </motion.button>
            </form>
          </div>
